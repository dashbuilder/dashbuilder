...
* Create a "<mydataset>.dset" file containng the data set JSON definition.
...
* Notice that <uuid> is the identifier of the data set you want to remove. If the data set has been previously deployed
  using the above mechanism then the UUID is the one defined within the ".dset" file. If it has been defined
