 ...
 * <p>Default ElasticSearch native client implementation is provided by classes in package <code>org.dashbuilder.dataprovider.backend.elasticsearch.rest.client.impl</code></p>
...
public interface ElasticSearchClient<T extends ElasticSearchClient> {
     ...
     * @return The number of documents for a given index/es and type/es
     */
    SearchResponse search(SearchRequest searchRequest) throws ElasticSearchClientGenericException;
}
