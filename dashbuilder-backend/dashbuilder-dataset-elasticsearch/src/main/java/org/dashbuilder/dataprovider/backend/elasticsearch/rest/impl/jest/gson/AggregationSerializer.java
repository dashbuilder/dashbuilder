    ...
    private String[] buildIntervalExtractorScript(String sourceId, ColumnGroup columnGroup) {
        ...
        switch (intervalType) {
            ...
            case DAY_OF_WEEK:
                ...
                // fixed values whatever the time zone or region is. So let's increment the date by one day (#next function),
                // so this way can be extracted the day of week using "uu" pattern.
