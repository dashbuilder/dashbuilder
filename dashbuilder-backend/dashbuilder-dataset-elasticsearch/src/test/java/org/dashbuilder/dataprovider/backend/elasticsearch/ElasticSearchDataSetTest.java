...
public class ElasticSearchDataSetTest extends ElasticSearchDataSetTestBase {
    ...
    public void testDefaultLookup() throws Exception {
        ...
        Date date = new SimpleDateFormat(DATE_PATTERN).parse("2012-12-11 -0900");
        ...
        date = new SimpleDateFormat(DATE_PATTERN).parse("2012-12-01 -0900");
        ...
        date = new SimpleDateFormat(DATE_PATTERN).parse("2012-05-11 -0900");
        ...
        date = new SimpleDateFormat(DATE_PATTERN).parse("2010-09-01 -0900");
        ...
        date = new SimpleDateFormat(DATE_PATTERN).parse("2009-04-14 -0900");
    ...
    public void testLookupTrim() throws Exception {
        ...
        Date date = new SimpleDateFormat(DATE_PATTERN).parse("2009-04-14 -0900");
