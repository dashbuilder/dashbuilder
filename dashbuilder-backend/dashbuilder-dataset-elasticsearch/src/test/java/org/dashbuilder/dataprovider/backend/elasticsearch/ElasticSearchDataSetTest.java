...
public class ElasticSearchDataSetTest extends ElasticSearchDataSetTestBase {
    ...
    public void testDefaultLookup() throws Exception {
        ...
        Date date = new SimpleDateFormat(DATE_FORMAT).parse("2015-12-11 +0000");
        ...
        date = new SimpleDateFormat(DATE_FORMAT).parse("2015-12-01 +0000");
        ...
        date = new SimpleDateFormat(DATE_FORMAT).parse("2015-05-11 +0000");
        ...
        date = new SimpleDateFormat(DATE_FORMAT).parse("2013-09-01 +0000");
        ...
        date = new SimpleDateFormat(DATE_FORMAT).parse("2012-04-14 +0000");
    ...
    public void testLookupTrim() throws Exception {
        ...
        Date date = new SimpleDateFormat(DATE_FORMAT).parse("2012-04-14 +0000");
