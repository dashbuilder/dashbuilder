...
@Portable
public class DisplayerSettingsOnFocusEvent {

    private DisplayerSettings displayerSettings;

    public DisplayerSettingsOnFocusEvent() {
    }

    public DisplayerSettingsOnFocusEvent(DisplayerSettings displayerSettings) {
