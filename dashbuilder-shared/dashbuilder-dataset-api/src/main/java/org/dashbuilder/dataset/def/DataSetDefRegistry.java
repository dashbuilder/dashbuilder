...
public interface DataSetDefRegistry {
    ...
    /**
     * Register a DataSetPreprocessor to a dataset.
     * @param uuid The unique universal identifier of the data set
     * @param preprocessor The data set definition
     */
    void registerDataSetDefPreProcessor(String dataSetUUID, DataSetPreprocessor preprocessor);
