 ...
 */
@Portable
public class PieChartKPIBuilder extends AbstractChartKPIBuilder<PieChartKPIBuilder> {

    protected DataDisplayerBuilder createDisplayerBuilder() {
        return new XAxisChartBuilder();
    }

    public PieChartKPIBuilder() {
        super();
        displayerBuilder.type(DataDisplayerType.PIECHART);
    }
}
