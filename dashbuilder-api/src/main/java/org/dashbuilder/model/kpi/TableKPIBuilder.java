 ...
 */
@Portable
public class TableKPIBuilder extends AbstractChartKPIBuilder<TableKPIBuilder> {

    protected DataDisplayerBuilder createDisplayerBuilder() {
        return new TableDisplayerBuilder();
    }

    public TableKPIBuilder() {
        super();
        displayerBuilder.type(DataDisplayerType.TABLE);
    }
}
