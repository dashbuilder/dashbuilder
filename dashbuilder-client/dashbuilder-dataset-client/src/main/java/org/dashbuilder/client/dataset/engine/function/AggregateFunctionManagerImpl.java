 ...
 */
package org.dashbuilder.client.dataset.engine.function;
...
public class AggregateFunctionManagerImpl implements AggregateFunctionManager {
    ...
    @PostConstruct
    protected void init() {
        registerFunction(SumFunction.CODE, new SumFunction());
        registerFunction(AverageFunction.CODE, new AverageFunction());
        registerFunction(MinFunction.CODE, new MinFunction());
        registerFunction(MaxFunction.CODE, new MaxFunction());
        registerFunction(CountFunction.CODE, new CountFunction());
        registerFunction(DistinctFunction.CODE, new DistinctFunction());
    }
