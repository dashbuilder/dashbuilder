...
public class DataSetSummary implements IsWidget {
    ...
    @Inject
    private Event<DataSetExploredErrorEvent> dataSetExploredErrorEvent;
    ...
    private String humanReadableRowCount(long rows) {
        int unit = 1000;
    ...
    private void showError(final String uuid, final String message) {
        dataSetExploredErrorEvent.fire(new DataSetExploredErrorEvent(uuid, message, null));
    }
