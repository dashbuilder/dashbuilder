...
public class CSVDataSetEditWorkflow extends DataSetEditWorkflow<CSVDataSetDef, CSVDataSetDefEditor> {
    ...
    protected Iterable<ConstraintViolation<?>> validate(boolean isCacheEnabled, boolean isPushEnabled, boolean isRefreshEnabled) {
        final Iterable<ConstraintViolation<?>> violations = dataSetDefValidator.validatorFor(DataSetProviderType.CSV).validate(dataSetDef,
                isCacheEnabled, isPushEnabled, isRefreshEnabled, editor.isUsingFilePath());
        return violations;
    }
