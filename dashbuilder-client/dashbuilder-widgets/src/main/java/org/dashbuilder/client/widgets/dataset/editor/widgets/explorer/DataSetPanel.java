...
public class DataSetPanel implements IsWidget {
    ...
    @Inject
    private Event<EditDataSetEvent> editDataSetEvent;
    ...
    private static SafeUri getTypeIconUri(final DataSetDef dataSetDef) {
    ...
    private static String getTypeIconTitle(final DataSetDef dataSetDef) {
        switch (dataSetDef.getProvider()) {
            case BEAN:
