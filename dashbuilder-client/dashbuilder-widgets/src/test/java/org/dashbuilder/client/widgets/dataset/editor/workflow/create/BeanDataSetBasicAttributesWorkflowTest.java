...
public class BeanDataSetBasicAttributesWorkflowTest  {
    ...
    @Mock org.dashbuilder.client.widgets.dataset.editor.bean.BeanDataSetDefAttributesEditor beanDataSetDefAttributesEditor;
    ...
    public void setup() throws Exception {
        presenter = new BeanDataSetBasicAttributesWorkflow(clientServices, dataSetDefValidator, beanManager, basicAttributesEditor, saveRequestEvent,
    ...
    public void testValidate() {
        ...
        presenter.validate();
        verify(beanDataSetDefValidator, times(1)).validateAttributes(any(BeanDataSetDef.class));
        verify(beanDataSetDefValidator, times(0)).validate(any(BeanDataSetDef.class), anyBoolean(), anyBoolean(), anyBoolean());
    }
