...
public class SQLDataSetEditWorkflowTest  {
    ...
    @Mock SimpleBeanEditorDriver<SQLDataSetDef, SQLDataSetDefEditor> driver;
    @Mock org.dashbuilder.client.widgets.dataset.editor.sql.SQLDataSetEditor sqlEditor;
    ...
    public void setup() throws Exception {
      presenter = new SQLDataSetEditWorkflow(clientServices, dataSetDefValidator, beanManager,
    ...
    public void testValidateUsingQuery() {
        ...
        verify(sqlDataSetDefValidator, times(0)).validateAttributes(dataSetDef, true);
    }
    ...
    public void testValidateUsingTable() {
        ...
        verify(sqlDataSetDefValidator, times(0)).validateAttributes(dataSetDef, false);
    }
